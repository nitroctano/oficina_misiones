...
//$mes = '05';
$mes = substr($_POST['fechaMisionero'],5,2);
//$anio = '2017';
$anio = substr($_POST['fechaMisionero'],0,4);
$usu = $_POST['idMisionero'];
$jsondata;
$cell = 6;
$mesLetra;
...
foreach ($jsondata[0] as &$value) {
	$objPHPExcel->setActiveSheetIndex(0)
		...
		->setCellValue('B'.$cell ,$value[2])
		->setCellValue('C'.$cell ,$value[5])
		->setCellValue('D'.$cell ,$value[6])
		->setCellValue('E'.$cell ,$value[3])
